                ...
                <div class="flex flex-col gap-y-5 white w-3/5">
                    ...
                    <div class="flex-1 bg-blue-500 rounded-lg my-1">
                        <a href="#" class="flex flex-row gap-x-4 m-1 justify-center items-center">
                            <img src="assets/img/Google-Logo.png" class="w-10 bg-white rounded-full"><p class="text-lg text-white">Login with Google</p>
                        </a>
                    </div>
                    ...
                    <div>
                        <form class="flex flex-1 flex-col gap-y-7" action="login.php" method="post">
                            ...
                            <input type="email" name="email" value="<?php echo ($_SESSION['remember'])? $_SESSION['email'] : ''; ?>" class="rounded-md border-2 border-gray-400 p-1.5" required>
                
                            <label for="password" class="-mb-5"><b>Password</b></label>
                            <input type="password" name="password" value="<?php echo ($_SESSION['remember'])? $_SESSION['password'] : ''; ?>" class="rounded-md border-2 border-gray-400 p-1.5" required>
                            
                            <div class="flex flex-row justify-between -mt-5">
                                <label>
                                <input type="checkbox" name="remember" <?php if($_SESSION['remember']) {echo 'checked="checked"';}?> > Remember me
                                <!-- </label>
